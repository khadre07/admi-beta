...
def main():
    ap = argparse.ArgumentParser(description="Générateur de licences ADMI")
    ...
    if args.name:
        print(f"# Licences ADMI pour : {args.name}")
